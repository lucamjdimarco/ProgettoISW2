...
public class Main {
    ...
    public static void createCommit(Commit[] commits){
    ...
    public static void writeFile(String line) throws IOException {
        ...
        String path = "/Users/lucadimarco/Desktop/Milestone/data.txt";
                            ...
                            for (JsonElement version : fixVersions.getAsJsonArray()) {
                                ...
                                switch(index){
                                    case 1:
                                        ...
                                        //writeFile("Key: " + key + ", Bug Version Name: " + name);
                                    ...
                                    case 2:
                                        ...
                                        //writeFile("Key: " + key + ", Fix Version Name: " + name2);
    ...
    public static void getCommand(String key) throws IOException {
        ...
        try {
            ...
            if(key != null){
                ...
                String directoryPath = "/Users/lucadimarco/Desktop/syncope/syncope";
